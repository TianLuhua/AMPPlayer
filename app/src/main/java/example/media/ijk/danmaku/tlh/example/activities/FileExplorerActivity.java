...
package example.media.ijk.danmaku.tlh.example.activities;
...
import example.media.ijk.danmaku.tlh.example.application.AppActivity;
import example.media.ijk.danmaku.tlh.example.application.Settings;
import example.media.ijk.danmaku.tlh.example.eventbus.FileExplorerEvents;
import example.media.ijk.danmaku.tlh.example.fragments.FileListFragment;
